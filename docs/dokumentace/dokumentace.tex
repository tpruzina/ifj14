...
Práce v teamu byla rozdělena následovně: Interpret dostal na starosti \textbf{Tomáš Pružina}. Parser a tedy syntaktickou a sémantickou část projektu vytvářel \textbf{Antonín Marko}.\textbf{Martin Juřík}, měl na starost zpracování lexikálního analyzátoru a jeho funkční otestování. Celkové testování, zpracování LL gramatiky a dokumentaci měl na starosti \textbf{Martin Kubíček}. \textbf{Petr David} úprava knihovních funkcí a vestavěné funkce do předmětu \verb|Algoritmy|.
...
Počet všech zdrojových souborů: 

celkový počet řádků: 

Velikost spustitelného programu (bez debugovacích informací, Linux 64bit): bytů

Velikost spustitelného programu (bez debugovacích informací, Windows 64bit): bytů
